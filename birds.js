const birds = [
  [       
    {
      ...
      descriptionEn: 'The raven is a large bird. The body length reaches 70 centimeters, the wingspan is up to one and a half meters. Ravens inhabit the vicinity of the Tower. There is a belief in England that the day the black crows fly away from the Tower, the monarchy will collapse.',
    ...
    },
    {
      ...
      descriptionEn: 'The sounds made by the crane are similar to the voiced "chicks - chickens". Cranes most often sing in a duet - one bird begins the song with the syllable "kur", and the second picks up "ly". If a bird sings alone, then it only makes the sound "chicken".',
    ...
    },
    {
      ...
      descriptionEn: "Swallows tend to chirp softly. The songs of the swallows do not stop throughout the summer. Researchers distinguish up to 6 chirping sounds in birds: “vit”, “vi-vit”, “chivit”, “chirivit”, etc. Swallows love to sing a duet.",
    ...
    },
    {
      ...
      descriptionEn: "The nightjar is an inconspicuous bird known for its voice. The song of the nightjar sounds like a monotonous trill similar to the rattling of a motorcycle. Such rattling is heard from dusk to dawn, its tonality, frequency and volume change. ",
    ...
    },
    {
      ...
      descriptionEn: "The cuckoo was named so because of the peculiarities of its songs. The voiced “cuckoo” cannot be confused with any other bird. Cuckoos do not build nests, their offspring are raised by other species of birds, to which cuckoos toss their eggs.",
    ...
    },
    {
      ...
      descriptionEn: "Over 40 different sound combinations are distinguished in the chirping of tits. They sing almost all year round, fading a little only in winter. Tits are real orderlies of the forest. One pair of tits during the nesting period protects dozens of trees from pests.",
  ...
  [
    {
      ...
      descriptionEn: "Sparrows are the most famous and recognizable birds. They are easily recognizable by their colorful plumage and perky chirping. Sparrows are a synatropic species - they settle close to human habitation.",
    ...
    },
    {
      ...
      descriptionEn: "Rooks are very smart and quick-witted birds. With the help of a beak, they create and use the simplest tools. Rooks have a developed reflex to the sounds of a tractor. Hearing the “rattle”, they fly towards the sound – the tractor is plowing the ground, which means that there is a lot of food in this place.",
    ...
    },
    {
      ...
      descriptionEn: "Thrush is the best singer of the sparrows. The song consists only of beautiful sonorous whistles and short trills. Most often it can be heard in the morning and evening. Thrushes sing during the entire nesting period.",
    ...
    },
    {
      ...
      descriptionEn: "Magpie is a very industrious bird. She builds up to eight nests, and then chooses the best of them. The entrance to the nest of magpies is always facing south, so that it is warmer in the dwelling. Magpies are the only birds that recognize themselves in a mirror.",
    ...
    },
    {
      ...
      descriptionEn: "When a jay gets excited, the crest on her head ruffles. The bird tries to create a frightening sight. Jays are able to imitate the voices of other birds, animals and the sounds that humans create. For the winter they store large stocks of acorns and nuts.",
  ...
  [
    {
      ...
      descriptionEn: "There are 450 species of finches in the wild. In winter, finches lead a flocking lifestyle. Sometimes sparrows can be seen in their families. Finches sing in the spring, with the onset of the mating season. Their singing is a flooded multi-minute roulades.",
    ...
    },
    {
      ...
      descriptionEn: "Klests are called 'Christmas' birds. Under natural conditions, they give birth in winter - in January. These birds insulate their nests with moss and animal hair, so the chicks are not cold. In search of cones crossbills can fly 3500 km from the nest.",
    ...
    },
    {
      ...
      descriptionEn: "The turtle dove lives in mixed and broad-leaved forests, as well as in city parks and villages. Birds often choose places of life next to humans and easily get used to people. Due to the melodic pleasant singing of turtle doves, they are often bred at home.",
    ...
    },
    {
      ...
      descriptionEn: "Hoopoes prefer to live in open landscapes with isolated trees or groves. The most convenient for the bird are the forest-steppe and savannah. A hoopoe can choose places of residence next to a person: pastures, vineyards, orchards.",
    ...
    },
    {
      ...
      descriptionEn: "The swift can be seen in almost every corner of the planet. They live both in forest areas and in open areas. Swifts live in large flocks. Large colonies of these birds can be seen in towns or on coastal cliffs.",
  ...
  [
    ...
    },
    {
      ...
      descriptionEn: "The melody of the oriole's voice has been compared to the sound of a flute. It is difficult for a person to see the oriole, as it lives high in the trees. The oriole is not only a very beautiful, but also a useful bird. It destroys poisonous caterpillars that other birds do not eat.",
    ...
    },
    {
      ...
      descriptionEn: "The waxwing has very prehensile claws, which helps the bird to hold on to branches and peck at hard-to-reach berries. During courtship, the male offers the female a berry or other treat. If the female accepts it, then the birds create a pair.",
  ...
  [
    ...
    },
    {
      ...
      descriptionEn: "The harrier is a small falcon. It feeds mainly on mouse-like rodents, the basis of its diet is voles, hamsters, and mice. The plumage of the Harrier may be ash grey. With such a bird is associated the comparison 'gray-haired like a harrier'.",
    ...
    },
    {
      ...
      descriptionEn: "Falco's Latin name for the falcon comes from the word 'sickle' because of the crescent shape of its wings. Long and wide wings allow the falcon to rise high into the sky and soar freely. The falcon's flight speed reaches 280-320 kilometers per hour.",
    ...
    },
    {
      ...
      descriptionEn: "All hawks have broad, short wings. Another distinguishing feature is the white 'eyebrows' above the eyes. Slavic warriors placed the image of a hawk on their banners as a symbol of courage, power and ruthlessness towards enemies.",
    ...
    },
    {
      ...
      descriptionEn: "The eagle owl's flight is silent, its vision is very sharp. These features make the bird an unsurpassed night hunter. The eagle owl has no natural enemies, not a single animal preys on adult birds. But foxes and wolves attack the chicks.",
  ...
  [
    {
      ...
      descriptionEn: "The Albatross is the largest flying bird in the world. The wingspan reaches three and a half, weight - ten kilograms. Albatrosses spend most of their lives in the air, covering vast distances above the oceans.",
    ...
    },
    {
      ...
      descriptionEn: "A feature of the blue-footed booby is not only the intense bright blue color of the legs, but also the fact that they are very warm. While other species of birds warm the clutches with their bodies, the blue-footed booby does this with the help of its paws.",
    ...
    },    
    {
      ...
      descriptionEn: "Petrels vary in size. The smallest of them are up to 25 cm long, the largest - up to 1 m, with a wingspan of about 2 m. There is a belief that the appearance of a petrel in the air portends a storm, as the very name of the bird says.",
    ...
    },
    {
      ...
      descriptionEn: "Pelicans are the inhabitants of the seas and rivers. They walk awkwardly, but fly and swim well. They feed mainly on fish, arrange collective hunts - lined up in a semicircle, they flap their wings and beaks on the water and force out the frightened fish in shallow water.",
    ...
    },
    {
      ...
      descriptionEn: "A male emperor penguin reaches a height of 130 cm and can weigh up to 50 kg. Of all modern penguins, this species is the largest. The penguin's diet consists of fish, squid and krill. Birds hunt in large groups in the ocean.",
    ...
    },
    {
      ...
      descriptionEn: "Seagulls inhabit the shores of the seas, lakes, rivers, reservoirs, swamps, often nest on islands. Since the end of the last century, seagulls began to appear in large cities, where they nest on the roofs of buildings. All seagulls lead a colonial way of life.",
